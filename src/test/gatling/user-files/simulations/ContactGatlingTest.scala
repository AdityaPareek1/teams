...
class ContactGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Contact entity")
        ...
        .repeat(2) {
            ...
            .get("/services/procurement/api/contacts")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new contact")
            .post("/services/procurement/api/contacts")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/procurement${new_contact_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created contact")
            .delete("/services/procurement${new_contact_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
