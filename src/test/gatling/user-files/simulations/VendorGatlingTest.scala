...
class VendorGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Vendor entity")
        ...
        .repeat(2) {
            ...
            .get("/services/procurement/api/vendors")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new vendor")
            .post("/services/procurement/api/vendors")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .repeat(5) {
                ...
                .get("/services/procurement${new_vendor_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created vendor")
            .delete("/services/procurement${new_vendor_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
